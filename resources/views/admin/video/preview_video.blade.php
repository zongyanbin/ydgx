...
<head>
    <style type="text/css">
        ...
        /*'first' => string 'http://mv04.cuctv.com/M00/01/01/rBFTjVy_1ReOjh1UAAAACibFkKw116-1.mp4' (length=68)*/
        /*'list' => string 'http://mv04.cuctv.com/M00/01/01/rBFTjVy_1ReOjh1UAAAACibFkKw116-2.mp4' (length=68)*/
        }
    </style>
