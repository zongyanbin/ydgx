...
trait GFEntrustUserTrait
{
    ...
    {   //both inserts and updates
        ...
        Cache::tags($this->role_user_table)->flush();
        return $result;
    }
    ...
    {
        return $this->belongsToMany(Config::get('entrust.role'), $this->role_user_table, $this->user_foreign_key, Config::get('entrust.role_foreign_key'));
    }
